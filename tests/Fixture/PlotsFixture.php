...
class PlotsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'number' => ['type' => 'integer', 'length' => 3, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'person_id__INDEX' => ['type' => 'index', 'columns' => ['person_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'number__UNIQUE' => ['type' => 'unique', 'columns' => ['number'], 'length' => []],
            'fk_people__id____plots__person_id' => ['type' => 'foreign', 'columns' => ['person_id'], 'references' => ['people', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_created' => '2020-01-27 09:28:38',
                'date_modified' => '2020-01-27 09:28:38',
            ],
        ];
        parent::init();
    }
