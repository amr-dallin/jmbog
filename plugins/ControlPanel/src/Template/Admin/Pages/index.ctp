<?php
$this->assign('title', __d('smart_admin', 'Dynamic pages'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('smart_admin', 'Dynamic pages')]
];
                ...
                <div class="panel-content">
                    <table class="table table-bordered table-hover table-striped w-100 datatable">
                        <thead>
                            <tr>
                                <th class="all"></th>
                                <th class="all" style="width: 60%"><?= __d('smart_admin', 'Title') ?></th>
                                <th class="min-desktop"><?= __d('smart_admin', 'Date Published') ?></th>
                                <th class="min-phone text-center"><?= __d('smart_admin', 'Mode') ?></th>
                                <th class="all"></th>
                            </tr>
                        </thead>
                        <tbody>
