<?php
$this->assign('title', __d('control_panel', 'Images'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('control_panel', 'Files'), 'url' => ['action' => 'index']],
    ['title' => __d('control_panel', 'Images')]
];
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content h-100 border-0 shadow-0">
            <div class="modal-header">
                <h5 class="modal-title h2"><?= __d('control_panel', 'Detail Image') ?></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <dl class="row border-bottom pb-4">
                            <dt class="col-md-4"><?= __d('control_panel', 'Filename') ?></dt>
                            <dd class="col-md-8 text-truncate" id="filename"></dd>
                            <dt class="col-md-4"><?= __d('control_panel', 'Mime Type') ?></dt>
                            <dd class="col-md-8 text-truncate" id="mimeType"></dd>
                            <dt class="col-md-4 text-truncate"><?= __d('control_panel', 'Date Created') ?></dt>
                            <dd class="col-md-8 text-truncate" id="created"></dd>
                            <dt class="col-md-4"><?= __d('control_panel', 'Filesize') ?></dt>
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item mr-4">
                                <?php
                                echo $this->Html->link(
                                    $this->Html->tag('i', '', ['class' => 'fal fa-copy mr-1']) . __d('control_panel', 'Copy URL'),
                                    '#',
                                    [
                                        'escape' => false,
                                        'id' => 'copy',
                            ...
                            <li class="list-inline-item mr-4" id="delete">
                                ...
                                echo $this->SmartHtml->postLink(
                                    $this->Html->tag('i', '', ['class' => 'fal fa-trash mr-1']) . __d('control_panel', 'Delete'),
                                    $this->Url->build(['action' => 'delete', 'FILE_ID']),
                                    [
                                        'id' => 'deleteLink',
                                        'class' => 'color-danger-900 mt-2 pr-2 mr-auto',
                                        'data-title' => __d('control_panel', 'Are you sure you want to delete the image?'),
