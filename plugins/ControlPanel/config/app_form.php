...
return [
    ...
    'file' => '<div class="custom-file"><input type="file" class="custom-file-input" name="{{name}}"{{attrs}}><label class="custom-file-label" for="customFile">' . __d('control_panel', 'Choose file') . '</label></div>',
