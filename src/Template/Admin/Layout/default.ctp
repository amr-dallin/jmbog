...
<html lang="en">
    ...
    <script>
            ...
            <div class="page-inner">
                    ...
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            echo $this->Html->image('logo.png', [
                                'alt' => __d('control_panel', 'Control panel'),
                                'aria-roledescription' => 'logo'
                            ]);
                            ?>
                            <span class="page-logo-text mr-1"><?= __d('control_panel', 'Control panel') ?></span>
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="page-logo">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="/control_panel/img/logo.png" alt="<?= __d('control_panel', 'Admin Panel') ?>" aria-roledescription="logo">
                                <span class="page-logo-text mr-1"><?= __d('control_panel', 'Admin Panel') ?></span>
                                <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>
                                <i class="fal fa-angle-down d-inline-block ml-1 fs-lg color-primary-300"></i>
                            </a>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    ...
                                    <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'settings']) ?>" class="dropdown-item">
                                        <span data-i18n="drpdwn.settings"><?= __d('control_panel', 'Settings') ?></span>
                                    </a>
                                    <div class="dropdown-divider m-0"></div>
                                    <a href="#" class="dropdown-item" data-action="app-fullscreen">
                                        <span data-i18n="drpdwn.fullscreen"><?= __d('control_panel', 'Fullscreen') ?></span>
                                        <i class="float-right text-muted fw-n">F11</i>
                                    </a>
                                    <a href="#" class="dropdown-item" data-action="app-print">
                                        <span data-i18n="drpdwn.print"><?= __d('control_panel', 'Print') ?></span>
                                        <i class="float-right text-muted fw-n">Ctrl + P</i>
                                    </a>
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="<?= $this->Url->build(['_name' => 'logout']) ?>">
                                        <span data-i18n="drpdwn.page-logout"><?= __d('control_panel', 'Logout') ?></span>
                                    ...
                                    <ul class="app-list w-auto h-auto p-0 text-left">
                                        <li>
                                            <a href="<?= $this->Url->build(['_name' => 'home']) ?>" class="app-list-item text-white border-0 m-0">
                                                ...
                                                <span class="app-list-name"><?= __d('control_panel', 'Home') ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <script>
            ...
            {
                let modalTitle = '<?php __d('control_panel', 'Are you sure?') ?>';
                if (title) {
                    modalTitle = title;
                }
                ...
                bootbox.confirm({
                    title: '<?= __d('control_panel', 'Critical action') ?>',
